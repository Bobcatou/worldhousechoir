...
function genesis_sample_google_fonts() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Days One|Arimo:400,700,400italic', array(), CHILD_THEME_VERSION );
...
function custom_header_inline_logo( $title, $inside, $wrap ) {
	...
	$logo = '<img src="' . get_stylesheet_directory_uri() . '/images/logo.png" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '" title="' . esc_attr( get_bloginfo( 'name' ) ) . '" width="100" height="133" />';
